...
|------|------|----------|------------|
| `type` | [ChatType](Version-2026.01.17-4b0f30090-Enums#chattype) | No | - |
...
|------|------|----------|------------|
| `message` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
| `secondaryMessage` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
| `icon` | `String` | Yes | 4096000 |
| `item` | [ItemWithAllMetadata](Version-2026.01.17-4b0f30090-Data-Types#itemwithallmetadata) | Yes | - |
| `style` | [NotificationStyle](Version-2026.01.17-4b0f30090-Enums#notificationstyle) | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `killer` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
| `decedent` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
| `icon` | `String` | Yes | 4096000 |
...
| `icon` | `String` | Yes | 4096000 |
| `isMajor` | `boolean` | No | - |
| `primaryTitle` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
| `secondaryTitle` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `page` | [Page](Version-2026.01.17-4b0f30090-Enums#page) | No | - |
...
|------|------|----------|------------|
| `clear` | `boolean` | No | - |
| `commands` | [CustomUICommand](Version-2026.01.17-4b0f30090-Data-Types#customuicommand)[] | Yes | 4096000 |
...
| `clear` | `boolean` | No | - |
| `lifetime` | [CustomPageLifetime](Version-2026.01.17-4b0f30090-Enums#custompagelifetime) | No | - |
| `commands` | [CustomUICommand](Version-2026.01.17-4b0f30090-Data-Types#customuicommand)[] | Yes | 4096000 |
| `eventBindings` | [CustomUIEventBinding](Version-2026.01.17-4b0f30090-Data-Types#customuieventbinding)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `type` | [CustomPageEventType](Version-2026.01.17-4b0f30090-Enums#custompageeventtype) | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `selection` | [EditorSelection](Version-2026.01.17-4b0f30090-Data-Types#editorselection) | Yes | - |
| `blocksChange` | [BlockChange](Version-2026.01.17-4b0f30090-Data-Types#blockchange)[] | Yes | 4096000 |
| `fluidsChange` | [FluidChange](Version-2026.01.17-4b0f30090-Data-Types#fluidchange)[] | Yes | 4096000 |
| `blocksCount` | `int` | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `players` | [ServerPlayerListPlayer](Version-2026.01.17-4b0f30090-Data-Types#serverplayerlistplayer)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `players` | [ServerPlayerListUpdate](Version-2026.01.17-4b0f30090-Data-Types#serverplayerlistupdate)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `state` | [PortalState](Version-2026.01.17-4b0f30090-Data-Types#portalstate) | Yes | - |
| `definition` | [PortalDef](Version-2026.01.17-4b0f30090-Data-Types#portaldef) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `visibleComponents` | [HudComponent](Version-2026.01.17-4b0f30090-Enums#hudcomponent)[] | Yes | 4096000 |
