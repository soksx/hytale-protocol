...
| `clientType` | [ClientType](Version-2026.01.15-c04fdfe10-Enums#clienttype) | No | - |
| `language` | `String` | Yes | 128 |
| `identityToken` | `String` | Yes | 8192 |
| `uuid` | `UUID` | No | - |
| `username` | `String` | No | 16 |
| `referralData` | `byte[]` | Yes | 4096 |
| `referralSource` | [HostAddress](Version-2026.01.15-c04fdfe10-Data-Types#hostaddress) | Yes | - |
...
| `type` | [DisconnectType](Version-2026.01.15-c04fdfe10-Enums#disconnecttype) | No | - |
...
|------|------|----------|------------|
| `id` | `int` | No | - |
| `time` | [InstantData](Version-2026.01.15-c04fdfe10-Data-Types#instantdata) | Yes | - |
...
| `id` | `int` | No | - |
| `time` | [InstantData](Version-2026.01.15-c04fdfe10-Data-Types#instantdata) | Yes | - |
| `type` | [PongType](Version-2026.01.15-c04fdfe10-Enums#pongtype) | No | - |
