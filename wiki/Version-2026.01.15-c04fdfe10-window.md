...
|------|------|----------|------------|
| `id` | `int` | No | - |
| `windowType` | [WindowType](Version-2026.01.15-c04fdfe10-Enums#windowtype) | No | - |
| `windowData` | `String` | Yes | 4096000 |
| `inventory` | [InventorySection](Version-2026.01.15-c04fdfe10-Data-Types#inventorysection) | Yes | - |
| `extraResources` | [ExtraResources](Version-2026.01.15-c04fdfe10-Data-Types#extraresources) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `type` | [WindowType](Version-2026.01.15-c04fdfe10-Enums#windowtype) | No | - |
