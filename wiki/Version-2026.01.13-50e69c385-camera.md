...
|------|------|----------|------------|
| `clientCameraView` | [ClientCameraView](Version-2026.01.13-50e69c385-Enums#clientcameraview) | No | - |
| `isLocked` | `boolean` | No | - |
| `cameraSettings` | [ServerCameraSettings](Version-2026.01.13-50e69c385-Data-Types#servercamerasettings) | Yes | - |
...
| `intensity` | `float` | No | - |
| `mode` | [AccumulationMode](Version-2026.01.13-50e69c385-Enums#accumulationmode) | No | - |
