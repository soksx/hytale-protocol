...
| `clientType` | [ClientType](Version-2026.01.17-4b0f30090-Enums#clienttype) | No | - |
| `language` | `String` | Yes | 128 |
| `identityToken` | `String` | Yes | 8192 |
| `uuid` | `UUID` | No | - |
| `username` | `String` | No | 16 |
| `referralData` | `byte[]` | Yes | 4096 |
| `referralSource` | [HostAddress](Version-2026.01.17-4b0f30090-Data-Types#hostaddress) | Yes | - |
...
| `type` | [DisconnectType](Version-2026.01.17-4b0f30090-Enums#disconnecttype) | No | - |
...
|------|------|----------|------------|
| `id` | `int` | No | - |
| `time` | [InstantData](Version-2026.01.17-4b0f30090-Data-Types#instantdata) | Yes | - |
...
| `id` | `int` | No | - |
| `time` | [InstantData](Version-2026.01.17-4b0f30090-Data-Types#instantdata) | Yes | - |
| `type` | [PongType](Version-2026.01.17-4b0f30090-Enums#pongtype) | No | - |
