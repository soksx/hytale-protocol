...
|------|------|----------|------------|
| `storage` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `armor` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `hotbar` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `utility` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `builderMaterial` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `tools` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
| `backpack` | [InventorySection](Version-2026.01.13-50e69c385-Data-Types#inventorysection) | Yes | - |
...
| `slotId` | `int` | No | - |
| `item` | [ItemQuantity](Version-2026.01.13-50e69c385-Data-Types#itemquantity) | No | - |
| `override` | `boolean` | No | - |
...
|------|------|----------|------------|
| `item` | [ItemQuantity](Version-2026.01.13-50e69c385-Data-Types#itemquantity) | No | - |
| `moveType` | [SmartMoveType](Version-2026.01.13-50e69c385-Enums#smartmovetype) | No | - |
...
|------|------|----------|------------|
| `inventorySectionId` | `int` | No | - |
| `inventoryActionType` | [InventoryActionType](Version-2026.01.13-50e69c385-Enums#inventoryactiontype) | No | - |
| `actionData` | `byte` | No | - |
