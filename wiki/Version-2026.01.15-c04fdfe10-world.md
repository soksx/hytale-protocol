...
| `y` | `int` | No | - |
| `z` | `int` | No | - |
| `cmds` | [SetBlockCmd](Version-2026.01.15-c04fdfe10-Data-Types#setblockcmd)[] | No | 4096000 |
...
| `y` | `int` | No | - |
| `z` | `int` | No | - |
| `cmds` | [SetFluidCmd](Version-2026.01.15-c04fdfe10-Data-Types#setfluidcmd)[] | No | 4096000 |
...
|------|------|----------|------------|
| `blockId` | `int` | No | - |
| `particleType` | [BlockParticleEvent](Version-2026.01.15-c04fdfe10-Enums#blockparticleevent) | No | - |
| `position` | [Position](Version-2026.01.15-c04fdfe10-Data-Types#position) | Yes | - |
...
| `grayFade` | `boolean` | No | - |
| `sleepUi` | `boolean` | No | - |
| `clock` | [SleepClock](Version-2026.01.15-c04fdfe10-Data-Types#sleepclock) | Yes | - |
| `multiplayer` | [SleepMultiplayer](Version-2026.01.15-c04fdfe10-Data-Types#sleepmultiplayer) | Yes | - |
