...
| `section` | `int` | No | - |
| `slot` | `int` | No | - |
| `group` | [BuilderToolArgGroup](Version-2026.01.17-4b0f30090-Enums#buildertoolarggroup) | No | - |
...
|------|------|----------|------------|
| `entityId` | `int` | No | - |
| `action` | [EntityToolAction](Version-2026.01.17-4b0f30090-Enums#entitytoolaction) | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `selectionMin` | [BlockPosition](Version-2026.01.17-4b0f30090-Data-Types#blockposition) | Yes | - |
| `selectionMax` | [BlockPosition](Version-2026.01.17-4b0f30090-Data-Types#blockposition) | Yes | - |
| `xNormal` | `int` | No | - |
| `yNormal` | `int` | No | - |
| `zNormal` | `int` | No | - |
| `numStacks` | `int` | No | - |
...
| `initialSelectionMin` | [BlockPosition](Version-2026.01.17-4b0f30090-Data-Types#blockposition) | Yes | - |
| `initialSelectionMax` | [BlockPosition](Version-2026.01.17-4b0f30090-Data-Types#blockposition) | Yes | - |
| `initialRotationOrigin` | [Vector3f](Version-2026.01.17-4b0f30090-Data-Types#vector3f) | Yes | - |
| `cutOriginal` | `boolean` | No | - |
| `applyTransformationToSelectionMinMax` | `boolean` | No | - |
| `isExitingTransformMode` | `boolean` | No | - |
| `initialPastePointForClipboardPaste` | [BlockPosition](Version-2026.01.17-4b0f30090-Data-Types#blockposition) | Yes | - |
...
|------|------|----------|------------|
| `angle` | `int` | No | - |
| `axis` | [Axis](Version-2026.01.17-4b0f30090-Enums#axis) | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `action` | [BuilderToolAction](Version-2026.01.17-4b0f30090-Enums#buildertoolaction) | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `type` | [InteractionType](Version-2026.01.17-4b0f30090-Enums#interactiontype) | No | - |
| `x` | `int` | No | - |
| `y` | `int` | No | - |
| `z` | `int` | No | - |
