...
|------|------|----------|------------|
| `clientCameraView` | [ClientCameraView](Version-2026.01.17-4b0f30090-Enums#clientcameraview) | No | - |
| `isLocked` | `boolean` | No | - |
| `cameraSettings` | [ServerCameraSettings](Version-2026.01.17-4b0f30090-Data-Types#servercamerasettings) | Yes | - |
...
| `intensity` | `float` | No | - |
| `mode` | [AccumulationMode](Version-2026.01.17-4b0f30090-Enums#accumulationmode) | No | - |
