...
|------|------|----------|------------|
| `type` | [UpdateType](Version-2026.01.13-50e69c385-Enums#updatetype) | No | - |
| `maxId` | `int` | No | - |
...
|------|------|----------|------------|
| `type` | [UpdateType](Version-2026.01.13-50e69c385-Enums#updatetype) | No | - |
| `itemCategories` | [ItemCategory](Version-2026.01.13-50e69c385-Data-Types#itemcategory)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `objective` | [Objective](Version-2026.01.13-50e69c385-Data-Types#objective) | Yes | - |
...
| `objectiveUuid` | `UUID` | No | - |
| `taskIndex` | `int` | No | - |
| `task` | [ObjectiveTask](Version-2026.01.13-50e69c385-Data-Types#objectivetask) | Yes | - |
