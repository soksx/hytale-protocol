...
| `updates` | [EntityUpdate](Version-2026.01.17-4b0f30090-Data-Types#entityupdate)[] | Yes | 4096000 |
...
| `slot` | [AnimationSlot](Version-2026.01.17-4b0f30090-Enums#animationslot) | No | - |
...
| `y` | `float` | No | - |
| `z` | `float` | No | - |
| `changeType` | [ChangeVelocityType](Version-2026.01.17-4b0f30090-Enums#changevelocitytype) | No | - |
| `config` | [VelocityConfig](Version-2026.01.17-4b0f30090-Data-Types#velocityconfig) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `hitPosition` | [Position](Version-2026.01.17-4b0f30090-Data-Types#position) | Yes | - |
| `x` | `float` | No | - |
| `y` | `float` | No | - |
| `z` | `float` | No | - |
| `changeType` | [ChangeVelocityType](Version-2026.01.17-4b0f30090-Enums#changevelocitytype) | No | - |
...
|------|------|----------|------------|
| `entityId` | `int` | No | - |
| `modelParticles` | [ModelParticle](Version-2026.01.17-4b0f30090-Data-Types#modelparticle)[] | Yes | 4096000 |
