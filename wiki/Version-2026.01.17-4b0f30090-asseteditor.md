...
|------|------|----------|------------|
| `token` | `int` | No | - |
| `message` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `schemas` | [SchemaFile](Version-2026.01.17-4b0f30090-Data-Types#schemafile)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `assetTypes` | [AssetEditorAssetType](Version-2026.01.17-4b0f30090-Data-Types#asseteditorassettype)[] | Yes | 4096000 |
...
| `token` | `int` | No | - |
| `path` | [AssetPath](Version-2026.01.17-4b0f30090-Data-Types#assetpath) | Yes | - |
| `newPath` | [AssetPath](Version-2026.01.17-4b0f30090-Data-Types#assetpath) | Yes | - |
...
| `manifest` | [AssetPackManifest](Version-2026.01.17-4b0f30090-Data-Types#assetpackmanifest) | Yes | - |
...
| `tree` | [AssetEditorFileTree](Version-2026.01.17-4b0f30090-Enums#asseteditorfiletree) | No | - |
| `paths` | [AssetEditorFileEntry](Version-2026.01.17-4b0f30090-Data-Types#asseteditorfileentry)[] | Yes | 4096000 |
...
|------|------|----------|------------|
| `pack` | `String` | Yes | 4096000 |
| `additions` | [AssetEditorFileEntry](Version-2026.01.17-4b0f30090-Data-Types#asseteditorfileentry)[] | Yes | 4096000 |
| `deletions` | [AssetEditorFileEntry](Version-2026.01.17-4b0f30090-Data-Types#asseteditorfileentry)[] | Yes | 4096000 |
...
| `path` | [AssetPath](Version-2026.01.17-4b0f30090-Data-Types#assetpath) | Yes | - |
| `assetIndex` | `int` | No | - |
| `commands` | [JsonUpdateCommand](Version-2026.01.17-4b0f30090-Data-Types#jsonupdatecommand)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `assets` | [TimestampedAssetReference](Version-2026.01.17-4b0f30090-Data-Types#timestampedassetreference)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `type` | [AssetEditorPopupNotificationType](Version-2026.01.17-4b0f30090-Enums#asseteditorpopupnotificationtype) | No | - |
| `message` | [FormattedMessage](Version-2026.01.17-4b0f30090-Data-Types#formattedmessage) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `assets` | [AssetInfo](Version-2026.01.17-4b0f30090-Data-Types#assetinfo)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `paths` | [AssetPath](Version-2026.01.17-4b0f30090-Data-Types#assetpath)[] | Yes | 4096000 |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `asset` | [AssetEditorAsset](Version-2026.01.17-4b0f30090-Data-Types#asseteditorasset) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `asset` | [AssetEditorAsset](Version-2026.01.17-4b0f30090-Data-Types#asseteditorasset)[] | Yes | 4096000 |
...
|------|------|----------|------------|
| `token` | `int` | No | - |
| `command` | [JsonUpdateCommand](Version-2026.01.17-4b0f30090-Data-Types#jsonupdatecommand) | Yes | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `gameTime` | [InstantData](Version-2026.01.17-4b0f30090-Data-Types#instantdata) | Yes | - |
| `paused` | `boolean` | No | - |
...
| Name | Type | Nullable | Max Length |
|------|------|----------|------------|
| `assetPath` | [AssetPath](Version-2026.01.17-4b0f30090-Data-Types#assetpath) | Yes | - |
| `model` | [Model](Version-2026.01.17-4b0f30090-Data-Types#model) | Yes | - |
| `block` | [BlockType](Version-2026.01.17-4b0f30090-Data-Types#blocktype) | Yes | - |
| `camera` | [AssetEditorPreviewCameraSettings](Version-2026.01.17-4b0f30090-Data-Types#asseteditorpreviewcamerasettings) | Yes | - |
