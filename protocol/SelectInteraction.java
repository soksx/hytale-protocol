   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 53) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 53 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 53 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 53 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 53 + cameraOffset;
         ...
         if ((nullBits & 64) != 0) {
            ...
            for (int i = 0; i < hitEntityRulesCount; i++) {
               ValidationResult structResult = HitEntity.validateStructure(buffer, posxxxxxx);
               if (!structResult.isValid()) {
                  return ValidationResult.error("Invalid HitEntity in HitEntityRules[" + i + "]: " + structResult.error());
               }

               posxxxxxx += HitEntity.computeBytesConsumed(buffer, posxxxxxx);
            }
         }
