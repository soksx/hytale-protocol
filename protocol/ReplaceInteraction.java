   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 39) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 39 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 39 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 39 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 39 + cameraOffset;
