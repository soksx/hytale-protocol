   ...
   public static SerialInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         for (int ix = 0; ix < serialInteractionsCount; ix++) {
            obj.serialInteractions[ix] = buf.getIntLE(varPos5 + varIntLen + ix * 4);
         }
      }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 35) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 35 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 35 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 35 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 35 + cameraOffset;
         ...
         if ((nullBits & 32) != 0) {
            ...
            posxxxxx += serialInteractionsCount * 4;
            if (posxxxxx > buffer.writerIndex()) {
