   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 49) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 49 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 49 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 49 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 49 + cameraOffset;
