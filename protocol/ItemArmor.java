   ...
   public static ItemArmor deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 4) != 0) {
         ...
         for (int i = 0; i < damageResistanceCount; i++) {
            ...
            if ((long)(dictPos + valVarLenx) + (long)valLenx * 6L > (long)buf.readableBytes()) {
      ...
      if ((nullBits & 8) != 0) {
         ...
         for (int i = 0; i < damageEnhancementCount; i++) {
            ...
            if ((long)(dictPos + valVarLenxx) + (long)valLenxx * 6L > (long)buf.readableBytes()) {
      ...
      if ((nullBits & 16) != 0) {
         ...
         for (int i = 0; i < damageClassEnhancementCount; i++) {
            ...
            if ((long)(dictPos + valVarLenxxx) + (long)valLenxxx * 6L > (long)buf.readableBytes()) {
