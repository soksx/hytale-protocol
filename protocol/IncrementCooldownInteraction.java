   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 56) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 56 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 56 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 56 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 56 + cameraOffset;
