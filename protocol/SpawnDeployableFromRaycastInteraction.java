   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 51) {
         ...
         if ((nullBits & 2) != 0) {
            ...
            int posx = offset + 51 + settingsOffset;
         ...
         if ((nullBits & 4) != 0) {
            ...
            int posxx = offset + 51 + rulesOffset;
         ...
         if ((nullBits & 8) != 0) {
            ...
            int posxxx = offset + 51 + tagsOffset;
         ...
         if ((nullBits & 16) != 0) {
            ...
            int posxxxx = offset + 51 + cameraOffset;
